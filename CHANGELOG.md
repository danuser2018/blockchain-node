...
- Uso de lombok para eliminar código boiler-plate en los constructores

## [1.16.1] - 2023-03-25

### Arreglado

- Se arreglan code smells encontrados por sonar sobre la versión 1.16.0

## [1.16.0] - 2023-03-25

### Añadido

- Event loop para modelar el flujo principal de la aplicación y el tratamiento de los eventos recibidos
